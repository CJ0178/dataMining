...
<div class=" mt-6 text-2xl px-24">
    <p class="text-center">
        ...
        Status "Non-Married": individu yang belum menikah sama sekali, atau telah bercerai
    </p>
    <br>
    <p class="mt-8 text-2xl">
        Sebuah studi menunjukkan bahwa individu yang bercerai/janda lebih mungkin untuk mengalami depresi, dibandingkan dengan yang menikah/belum menikah.
